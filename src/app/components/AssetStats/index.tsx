...
export default function AssetStats({
  ...
  const handleRemove = (id: string) => {
    const updatedAssets = assetCoins.filter((coin) => coin.id !== id);
    ...
    <div className="w-full flex items-center justify-center">
      <div className="w-full mt-10 mb-10 z-100 flex flex-col gap-4">
        {assetCoins.map((asset: Coin) => {
          return (
            <div
              className={`relative  ${isEdit ? "animate-wobble" : ""}`}
              key={asset.uid}
            >
              {isEdit && (
              ...
              <div className="w-full h-60  dark:bg-[#191932] rounded-xl flex justify-start overflow-hidden">
                ...
                <div className="w-2/3 bg-[#191932] p-6 grid grid-cols-2 gap-4">
                  <div className="p-3 flex flex-col border-dashed border-2 border-gray-500 rounded-lg">
                    ...
                    <div className="text-[#D1D1D1] font-light">
                      Current Price
                    </div>
                  </div>
                  <div className="p-3 flex flex-col border-dashed border-2 border-gray-500  rounded-lg">
